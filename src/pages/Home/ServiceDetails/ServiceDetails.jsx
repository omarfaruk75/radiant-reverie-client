...
//     if (provider.email === user?.email) return
//     return (
...
//                     <img className="border-4 h-12 w-12 border-cyan-500 font-bold rounded-full " src={provider?.photo} alt='' />
//                 </div>
//                 <div className=' flex ps-12 flex-row justify-between items-center'>
//                     <div>
//                         <p className='mt-2 text-sm  text-gray-600 '>    <span className="font-bold">Name:</span> {provider?.name}.</p>
...
const ServiceDetails = () => {
    const service = useLoaderData();
    const { _id, serviceName, price, description, photo, location, provider } = service;
    const [isOpen, setIsOpen] = useState(false);
    const [startDate, setStartDate] = useState(new Date());
    const { user } = useAuth();
    const navigate = useNavigate();
                                    ...
                                    <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                        ...
                                        <div className="relative inline-block w-1/2 p-4 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-xl dark:bg-gray-900 sm:my-8 sm:p-6">
                                            ...
                                            <section className='p-2 mt-2 md:p-6 mx-auto rounded-md w-full bg-[#eaf1f7]'>
                                                ...
                                                <form onSubmit={handleSubmitForm} className="text-[#6E6B58]">
                                                    <div>
                                                        <label className='text-gray-700' htmlFor='serviceId'>
                                                            Service Id:
                                                        </label>
                                                        <input
                                                            id='serviceId'
                                                    ...
                                                    <div>
                                                        <label className='text-gray-700' htmlFor='serviceName'>
                                                            Service Name:
                                                        </label>
                                                        <input
                                                            id='serviceName'
                                                    ...
                                                    <div className='flex flex-row mt-6'>
                                                        <button className='px-8 py-2.5 w-full text-center leading-5 text-white font-medium bg-[#6e6b58] transition-colors duration-300 transform rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600'>
                                                            Make A Purchase
                                                        </button>
                                                    </div>
                                                </form>
